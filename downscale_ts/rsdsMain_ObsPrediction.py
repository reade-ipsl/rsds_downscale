...
OUT_DIR=Path('results/rsds_ObsPrediction/')
...
def main():
    ...
    if not os.path.exists(pdir / Path('timeseries')): os.makedirs(pdir / Path('timeseries'))
    if not os.path.exists(pdir / Path('ex_dayts')): os.makedirs(pdir / Path('ex_dayts'))
    if not os.path.exists(pdir / Path('ex_weekts')): os.makedirs(pdir / Path('ex_weekts'))
    if not os.path.exists(pdir / Path('2dpdfs')): os.makedirs(pdir / Path('2dpdfs'))
    if not os.path.exists(pdir / Path('1dpdfs')): os.makedirs(pdir / Path('1dpdfs'))
    ...
    for yrpred in yearS_P_List:
        ...
        dataset.to_csv(pdir / 'timeseries' / Path('SARAH3_DATEst_SIS_30MIN_'+str(yrpred)+'_'+location1+'.csv'), index=True, index_label='time', float_format='%6.1f')
        ...
        dataset.to_csv(pdir / 'timeseries' / Path('SARAH3_DATEst_SID_30MIN_'+str(yrpred)+'_'+location1+'.csv'), index=True, index_label='time', float_format='%6.1f')
        ...
        dataset.to_csv(pdir / 'timeseries' / Path('ML'+mlist_code+'_DATEst_SIS_30MIN_'+str(yrpred)+'_'+location1+'.csv'), index=True, index_label='time', float_format='%6.1f')
        ...
        dataset.to_csv(pdir / 'timeseries' / Path('ML'+mlist_code+'_DATEst_SID_30MIN_'+str(yrpred)+'_'+location1+'.csv'), index=True, index_label='time', float_format='%6.1f')
        ...
        dataset.to_csv(pdir / 'timeseries' / Path('MLR56_DATEst_SIS_30MIN_'+str(yrpred)+'_'+location1+'.csv'), index=True, index_label='time', float_format='%6.1f')
        ...
        dataset.to_csv(pdir / 'timeseries' / Path('MLR56_DATEst_SID_30MIN_'+str(yrpred)+'_'+location1+'.csv'), index=True, index_label='time', float_format='%6.1f')
    ...
    for ii in range(numEXyears*4):
        ...
        filename=pdir / 'ex_dayts' / Path('rsdsINPUTTARGET'+fsetup_txt+'_PR_Day'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(FIGWIDTH,FIGHEIGHT), layout='constrained')
        ...
        # TOTAL Plot Sample prediction and target
        # - AND include original predictand
        filename=pdir / 'ex_dayts' / Path('rsdsTOT'+fsetup_txt+'_PR_Day'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(FIGWIDTH,FIGHEIGHT), layout='constrained')
        ...
        # - AND include original predictand
        filename=pdir / 'ex_dayts' / Path('rsdsDIR'+fsetup_txt+'_PR_Day'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(FIGWIDTH,FIGHEIGHT), layout='constrained')
        ...
        # - AND include original predictand
        filename=pdir / 'ex_dayts' / Path('rsdsTOTmMLR56'+fsetup_txt+'_PR_Day'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(FIGWIDTH,FIGHEIGHT), layout='constrained')
        ...
        # - AND include original predictand
        filename=pdir / 'ex_dayts' / Path('rsdsDIRmMLR56'+fsetup_txt+'_PR_Day'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(FIGWIDTH,FIGHEIGHT), layout='constrained')
    ...
    for ii in range(numEXyears*4):
        ...
        # TOTAL Plot Sample prediction and target
        # - AND include original predictand
        filename=pdir / 'ex_weekts' / Path('rsdsTOT'+fsetup_txt+'_PR_1week'+daynumtxt+'.png')
        ...
        # DIRECT Plot Sample prediction and target
        # - AND include original predictand
        filename=pdir / 'ex_weekts' / Path('rsdsDIR'+fsetup_txt+'_PR_1week'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(T2FIGWIDTH,FIGHEIGHT), layout='constrained')
        ...
        # TOTAL Plot Sample prediction and target - MLR56
        # - AND include original predictand
        filename=pdir / 'ex_weekts' / Path('rsdsTOTmMLR56'+fsetup_txt+'_PR_1week'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(T2FIGWIDTH,FIGHEIGHT), layout='constrained')
        ...
        # DIRECT Plot Sample prediction and target - MLR56
        # - AND include original predictand
        filename=pdir / 'ex_weekts' / Path('rsdsDIRmMLR56'+fsetup_txt+'_PR_1week'+daynumtxt+'.png')
        fig, ax = plt.subplots(figsize=(T2FIGWIDTH,FIGHEIGHT), layout='constrained')
